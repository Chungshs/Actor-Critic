...
class TD3Agent():
    def __init__(self, env: object, gamma: float, delay_step: int, tau: float, buffer_maxlen: int, 
     noise_std: float, noise_bound: float, critic_lr: float, actor_lr:float):
        ...
        self.target_critic2 = Critic(self.obs_dim, self.action_dim).to(self.device)
