...
from sacv2 import SACAgent
from sacv2_utils import mini_batch_train
import gym
import json
...
alpha_lr = params_manager.get_agent_params()['ALPHA_LEARN_RATE']
reward_scale = params_manager.get_agent_params()['REWARD_SCALE']

# Class 생성후 Train
agent = SACAgent(env, gamma, tau, buffer_maxlen, critic_lr, actor_lr, reward_scale, alpha_lr)
