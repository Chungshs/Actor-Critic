...
class Critic(nn.Module):
    ...
    def __init__(self, obs_dim: int, action_dim: int):
        ...
        self.linear1 = nn.Linear(self.obs_dim + self.action_dim, 400)
    ...
    def forward(self, x: torch.Tensor, a: torch.Tensor)-> torch.Tensor:
        ...
        x = F.relu(self.linear1(xa_cat))
        xa = F.relu(self.linear2(x))
...
class Actor(nn.Module):
    ...
    def __init__(self, obs_dim: int, action_dim: int):
        ...
        # The format is (input size, output size)
        self.linear1 = nn.Linear(self.obs_dim + self.action_dim-1, 400)
        self.linear2 = nn.Linear(400, 300)
        self.linear3 = nn.Linear(300, 1)
